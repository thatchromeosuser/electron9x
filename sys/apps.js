    ...
    le._apps = {
        ...
        */
        ...
        js: {
            ...
            // inject: "arguments",
            exec: function(url, opt) {
                var arg = this.arg.command.replace("js ", "")
                console.log(arg);
        ...
        */
        ...
        acidbox: {
            ...
            exec: function(opt) {
                $window.call(this, {
                    url: "/electron9x/c/programs/acidBox93/index.html",
                    width: 600,
                    height: 400,
                    resizable: false,
                    maximizable: false,
        ...
        starwars: {
            ...
            exec: function(opt) {
                $window.call(this, {
                    url: "/electron9x/c/programs/starwars/index.html",
                    width: 429,
                    height: 177,
        ...
        defrag: {
            ...
            exec: function() {
                $window.call(this, {
                    url: "/electron9x/c/programs/defrag/index.php",
                    width: 640,
                    height: 495,
                    resizable: false,
                    maximizable: false,
        ...
        gameoflife: {
            ...
            exec: function() {
                $window.call(this, {
                    url: "/electron9x/c/programs/gameOfLife/index.html",
                    width: 600,
                    height: 600,
                    resizable: false,
                    maximizable: false,
        ...
        whatif: {
            ...
            exec: function() {
                $window.call(this, {
                    url: "/electron9x/c/programs/matrix/index.php",
                    width: 600,
                    height: 300,
                });
            },
        ...
        takethis: {
            ...
            exec: function() {
                $window.call(this, {
                    url: "/electron9x/c/programs/dangerous/index.html",
                    width: 500,
                    height: 440,
                    footer: "&nbsp;",
                    resizable: false,
        ...
        speech: {
            ...
            exec: function() {
                $window.call(this, {
                    url: "/electron9x/c/programs/speech/index.php",
                    width: 200,
                    height: 420,
                    help: "Chrome only :(",
                    resizable: false,
        ...
        hampster: {
            ...
            exec: function() {
                var data = {
                    url: "/electron9x/c/programs/hampsterDance/index.html",
                    icon: "/c/programs/castleGafa/icon.gif",
                    bodyClass: "skin_inset_deep skin_light",
                    width: 485,
                    height: 418,
        ...
        trollbox: {
            ...
            exec: function() {
                var data = {
                    url: "http://www.windows93.net/trollbox/index.php",
                    width: 640,
                    height: 400,
                };
                $window.call(this, data);
        ...
        //stream93: "stream"
        alias: {
            categories: "Utility;Electron93;Aliases",
            silent: true,
            exec: function() {
                if (this.arg.arguments[0] === undefined) {
                    $log('<span style="color: #0000ff">Alias\nUsage: alias [app] [aliasName]</span>');
                } else {
                    var input = this.arg.arguments[0];
                    var output = this.arg.arguments[1];
                    if (le._apps.hasOwnProperty(input)) {
                        if (le._apps.hasOwnProperty(output)) {
                            $log('<span style="color: #ff0000">Alias/app exists!</span>');
                        } else {
                            le._apps[output] = {
                                alias: input,
                                name: le._apps[input].name,
                                icon: le._apps[input].icon,
                                categories: "Aliases;" + (le._apps[input].categories || ''),
                                exec: le._apps[input].exec
                            }
                            $log('<span style="color: #0f0">Alias created!</span>');
                        }
                    } else {
                        $log('<span style="color: #ff0000">App not found!</span>');
                    }
                }
            }
        },
        chat: {
            categories: "Network;Chat;Beta v2;Unfinished",
            terminal: !0,
            exec: function() {
                function e() {
                    var e = new Date,
                ...
                var o = new $socket("ws://darkok.xyz:8084"),
                    a = !1;
                o.on("open", function() {
                        a = !0,
        ...
        settings: {
            categories: "System;Utility;Electron93",
            icon: "settings.png",
            name: "Control Panel",
            exec: function() {
                ...
                $window.call('', {
                    menu: [{
                        ...
                        name: 'Styles',
                        icon: '/c/sys/skins/w93/stats.png',
                        items: [{
                            name: 'Rainbow Folders',
                            action: function() {
                                $exe('fx acid .ui_icon__folder')
                            }
                        }, {
                            name: 'See-Through Windows',
                            action: function() {
                                $exe('fx xray .ui_window')
                            }
                        }, {
                            ...
                            name: 'About',
                            action: function() {
                                $alert.info('Styles are things done with fx commands. To activate Rainbow Folder, you have to have a folder on-screen. Commands: <br>Rainbow Folders: fx acid .ui_icon__folder<br>See-Through Windows: fx xray .ui_window<br>Flashing Lights: fx strobo')
                            }
                        }]
                    }, {
                        name: 'HOST Fans',
                        icon: '/c/sys/skins/w93/letter.png',
                        items: [{
                            name: 'HOSTFAN trollbox username',
                            action() {
                                $store.set('.config/trollbox/nick', 'HOSTFAN');
                            }
                        }]
                    }, {
                        name: 'More Tools',
                        ...
                        items: [{
                            name: 'Run',
                            action: function() {
                                $prompt('Just run something.', '', function(ok, txt) {
                                    if (ok) {
                                        $exe(txt)
                                    }
                                })
                            ...
                            name: 'Find',
                            action: function() {
                                $prompt('Just find something.', '', function(ok, txt) {
                                    if (ok) {
                                        $exe('find ' + txt + ' /')
                                    }
                                })
                        ...
                        name: 'Accessories',
                        icon: '/c/sys/skins/w93/16/start.png',
                        items: [{
                            name: 'CodeMirror',
                            action: function() {
                                $exe('code')
                            ...
                            action: function() {
                                ...
                                $alert('<b>HOST COMPLETE SECURITY</b>:<br>Keep this window running so viruses can\'t enter your computer! It stops any IE6, Glitches (Even Corglitches), Hydras, and DEREG32.exe! <b>Do not close this window.</b><small>Also, do not use killall or clean all. It will make you have the antivirus forever. And even though you won\'t get viruses, it will be bad if you waant to destoy your computer.</small>', function() {
                                    clearInterval(e)
                                })
                            }
                        }, {
                            ...
                            action: function() {
                                $alert('Internet explorer wil not run because you are trying to access the web.')
                            }
                        }]
                    }, {
                        name: 'Info',
                        icon: '/c/sys/skins/w93/info.png',
                        items: [{
                            name: 'Clean',
                            action: function() {
                                $alert.info('Cleans windows.<br>Clean All: Clears All Windows (exe: killall)<br>Virus Clean: Kills All Viruses (exe: doctor --clean)')
                            }
                        }, {
                            name: 'Styles',
                            action: function() {
                                $alert.info('Read about it on About.')
                            }
                        }]
                    }],
                    title: 'Control Panel',
