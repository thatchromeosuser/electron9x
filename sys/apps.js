    ...
    le._apps = {
        ...
        shutdown: {
            ...
            exec: function() {
                ...
                setTimeout(function() {
                    document.body.innerHTML = "<div style='display: table;width: 100%;height: " + window.innerHeight + "px;text-align:center;'><p style='display:table-cell;vertical-align:middle;'>It is now safe to shut down.</p></div>";
